...
export default function SideBar() {
  ...
  const ACTIVE_ROUTE =
    "bg-gray-800 text-white/50 p-2 inline-flex justify-center rounded-md hover:bg-gray-800 hover:text-white smooth-hover";
  const INACTIVE_ROUTE =
    " text-white/50 p-2 inline-flex justify-center rounded-md hover:bg-gray-800 hover:text-white smooth-hover";
  return (
    <div className="bg-gray-900 p-2 lg:py-10 sm:rounded-xl flex lg:flex-col justify-between">
